...
// await conn.awaitQuery(
//   "CREATE TABLE blockmeals (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, fromDate VARCHAR(100), toDate VARCHAR(100), meal VARCHAR(100), reason VARCHAR(100), studentId INT, FOREIGN KEY (studentId) REFERENCES students(id) ON DELETE CASCADE);"
// );
