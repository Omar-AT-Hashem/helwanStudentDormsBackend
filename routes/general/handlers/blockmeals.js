...
import manageBlockMealsPerm from "../../../middleware/perms/manageBlockMealsPerm.js";
...
blockmeals.get("/", authenticateTokenLevelTwo, index);
blockmeals.get(
  "/get-by-studentId/:studentId",
  authenticateTokenLevelTwo,
  getByStudentId
);
blockmeals.post("/", authenticateTokenLevelTwo, manageBlockMealsPerm, create);
